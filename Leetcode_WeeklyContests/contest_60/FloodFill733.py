...
class Solution(object):
    def flood_fl(self, image, sr, sc, target_color, newColor):
        ...
        self.flood_fl(image, sr, sc - 1, target_color, newColor)
        self.flood_fl(image, sr, sc + 1, target_color, newColor)
        self.flood_fl(image, sr - 1, sc, target_color, newColor)
        self.flood_fl(image, sr + 1, sc, target_color, newColor)
    ...
    def floodFill(self, image, sr, sc, newColor):
        ...
        self.flood_fl(image, sr, sc, target_color, newColor)
        return image